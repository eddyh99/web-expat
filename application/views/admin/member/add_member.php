        ...
        <div class="col-lg-12 d-flex align-items-strech">
            <div class="card border-expat w-100">
                <div class="card-body">
                    ...
                    <?php } ?>
                    <h5 class="card-title fw-semibold mb-4">Add Member</h5>
                    <form action="<?= base_url()?>member/addmember_process" method="POST">
                        ...
                        <button type="submit" class="btn btn-expat mt-3">Save Member</button>
                  </form>
                </div>
            </div>
        </div>
